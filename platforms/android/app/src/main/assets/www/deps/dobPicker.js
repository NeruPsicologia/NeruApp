...
jQuery.extend({
    ...
    dobPicker: function (params) {
        ...
        if($(params.daySelector).length>0){
            $(params.daySelector)[0].selectedIndex = 0;
            $(params.daySelector).selectmenu("refresh");
        }
        if($(params.monthSelector).length>0){
            $(params.monthSelector)[0].selectedIndex = 0;
            $(params.monthSelector).selectmenu("refresh");
        }
        if($(params.daySelector).length>0){
            $(params.daySelector)[0].selectedIndex = 0;
            $(params.yearSelector).selectmenu("refresh");
        }
